<#
.Synopsis
   SaleRequest-Multiple-Prod.ps1 sends a http post of a Sale Request to Auction.com
...
.EXAMPLE
   ...
   \Auction\SaleRequests\{files generated by feinsuch}
...
.OUTPUTS
   ...
   Files: response.xml, response-content.xml, 

   response.xml contains more information about the web request and the body of the response may be
   ...
   MARRIAGE-FILE contains the trustee-reference-id, call_id (Requested data from customer)
.NOTES
   General notes
#>
...
Foreach-Object {
   ...
   $Url = "https://feeds.qa.auction.com/listener/dropbox/$account/$password"
