...
.NOTES
   ...
   PRODUCTION 
   01 - https://live.feeds.auction.com/listener/dropbox/your-account/*************************
   05 - https://live.feeds.auction.com/listener/xml/?account=your-account&password=*************************&request=trustee-postpone
   06 - https://live.feeds.auction.com/listener/xml/?account=your-account&password=*************************&request=trustee-cancel
   07 - OUTBOUND to customers endpoint from Auction.com [NOT USING]
   08 - https://lives.feeds.auction.com/listener/xml/?account=your-account&password=*************************&request=trustee-bidinstruction
   09 - https://live.feeds.auction.com/listener/xml/?account=your-account&password=*************************&request=trustee-inbound-sales-results
#>
...
# For ease of management two diff .ps1 files is ok as well so we don't push dev data to prod by mistake
...
# PRODUCTION URL: live.feeds.auction.com
$Url = "https://live.feeds.auction.com/listener/xml/?account=$account&password=$password&request=$request"
